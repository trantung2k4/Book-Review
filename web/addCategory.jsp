...
<html lang="en">
    <head>
        ...
        <title>RING!-MANAGEMENT - Thêm danh mục</title>
                    ...
                    <div class="row">
                        <div class="bill-to">
                            <div class="col-sm-12 clearfix">
                                <p style="margin-left: 30px;">Thông tin danh mục</p>
                                <div class="form-two">
                                    <form id="addproductform" style="width: 200%" action="addCategory" method="post">
